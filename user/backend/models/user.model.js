...
const userSchema = new mongoose.Schema(
	{
		...
		// Elevated hierarchy for sub-admin features (HOD/Faculty/Management)
		adminHierarchy: {
			type: String,
			enum: [
				// Institute hierarchy
		...
		// Whether the user's email/profile is verified. We default to false but the
		// signup flow may set this to true for local/dev convenience.
		isVerified: {
			type: Boolean,
			default: false,
		},
