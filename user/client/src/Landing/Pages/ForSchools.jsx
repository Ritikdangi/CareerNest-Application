        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Set your students up for success—long after graduation. CareerNest gives K-12 and independent schools a simple, secure platform to keep graduates engaged, proud, and invested in their alma mater.
            </p>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8">
              Join schools across the country who are creating lasting connections with CareerNest.
            </p>
            <motion.button 
