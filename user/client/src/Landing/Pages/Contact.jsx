        ...
        <div className="container w-11/12 mx-auto px-4 md:px-6">
          ...
          >
            ...
            <p className="text-lg text-gray-600 mb-8">
              Have questions about CareerNest? We're here to help you connect with your alumni community.
            </p>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        <a href="mailto:support@careernest.com" className="hover:text-[#fe6019] transition-colors">
                          support@careernest.com
                        </a><br />
                        <a href="mailto:info@careernest.com" className="hover:text-[#fe6019] transition-colors">
                          info@careernest.com
                        </a>
                      </p>
                    </div>
        ...
        <div className="container w-11/12 mx-auto px-4 md:px-6">
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              Find quick answers to common questions about CareerNest
            </p>
          </motion.div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid gap-6">
              {[
                {
                  question: "How do I sign up for CareerNest?",
                ...
                {
                  question: "Is CareerNest available for all educational institutions?",
                  answer: "Yes, CareerNest is designed for universities, colleges, high schools, and other educational institutions. If your school isn't already on our platform, you can contact us to learn about getting your institution set up."
                },
                {
                  question: "How much does it cost to use CareerNest?",
                  answer: "CareerNest offers different pricing tiers based on institution size and features needed. Basic alumni accounts are free, while institutions pay a subscription fee. Contact our sales team for detailed pricing information."
                },
                {
                ...
                {
                  question: "Can I delete my account if I no longer wish to use CareerNest?",
            ...
            <div className="text-center mt-10">
              ...
              <a href="mailto:support@careernest.com" className="inline-flex items-center gap-2 text-[#fe6019] font-medium hover:underline">
                <Mail size={16} />
