        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Build lasting relationships with a powerful community of talent. CareerNest lets your organization connect with graduates and professionals from top institutes, making it easier to recruit, partner, and ignite innovation.
            </p>
            ...
            >
              <div className="text-center">
                ...
                <h4 className="text-2xl font-bold text-gray-900 mb-4">
                  "CareerNest connects us directly to the right people—fast."
                </h4>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8">
              Join forward-thinking companies who are building meaningful relationships through CareerNest.
            </p>
            <motion.button 
