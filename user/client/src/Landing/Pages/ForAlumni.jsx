        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              CareerNest lets you connect, grow, and thrive alongside fellow graduates. Whether you want to reconnect, find mentors, discover opportunities, or give back, you're in the right place.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Unlock the full potential of your alumni and career network with tools designed specifically for professional and personal growth.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-8">
                From professional networking to career advancement, CareerNest provides all the tools you need to make the most of your alumni connections.
              </p>
            ...
            >
              <div className="text-center">
                ...
                <h4 className="text-2xl font-bold text-gray-900 mb-4">
                  "Through CareerNest, I found a mentor who changed my career path."
                </h4>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Join thousands of alumni who are already connecting, growing, and thriving together on CareerNest.
            </p>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8">
              Your community is waiting. Join CareerNest today and start building meaningful connections.
            </p>
            <motion.button 
