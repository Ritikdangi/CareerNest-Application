            ...
            >
              <div className="mb-10">
                ...
                <p className="text-gray-600">
                  Welcome to CareerNest. These Terms and Conditions govern your use of our website, mobile applications, and services (collectively, the "Platform"). By accessing or using our Platform, you agree to be bound by these Terms. If you disagree with any part of these terms, you may not access the Platform.
                </p>
                <p className="text-gray-600">
                  CareerNest provides an online platform connecting educational institutions with their alumni and career communities, offering features such as alumni directories, event management, fundraising tools, job boards, and communication systems.
                </p>
              </div>
              ...
              <div className="mb-10">
                ...
                <p className="text-gray-600">
                  CareerNest offers different types of accounts:
                </p>
                <ul>
              ...
              <div className="mb-10">
                ...
                <h3 className="text-xl font-semibold mb-2 text-gray-800">CareerNest Content</h3>
                <p className="text-gray-600">
                  Unless otherwise indicated, the Platform and all content and other materials therein, including, without limitation, the CareerNest logo and all designs, text, graphics, pictures, information, data, software, and files relating to the Platform (collectively, "CareerNest Content") are the proprietary property of CareerNest or our licensors and are protected by intellectual property laws.
                </p>
              </div>
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                By using CareerNest, you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions.
              </p>
