...
const ForInstitutes = () => {
  ...
  return (
    <>
      <SEO 
        title="CareerNest for Educational Institutes - Alumni & Career Management Platform"
        description="Transform your alumni and career network with CareerNest's comprehensive engagement platform. Boost engagement, fundraising, and institutional growth. Get started today!"
        ...
        url="https://www.careernest.com/landing/for-institutes"
        canonical="https://www.careernest.com/landing/for-institutes"
      />
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-[#fe6019] to-orange-600">
              ...
              Turn alumni into lifelong champions for your institution. CareerNest is the all-in-one alumni & career engagement platform that helps you reconnect graduates, foster mentorship, and unlock opportunities—while generating meaningful returns.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-8">
                From alumni directories to fundraising tools, CareerNest provides all the features institutes need to build thriving alumni communities.
              </p>
            ...
            >
              <div className="text-center">
                ...
                <h4 className="text-2xl font-bold text-gray-900 mb-4">
                  "With CareerNest, our alumni feel valued—and so does our bottom line."
                </h4>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8">
              Join leading institutions who are transforming their alumni and career networks with CareerNest.
            </p>
            <motion.button 
