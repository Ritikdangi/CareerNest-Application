...
const About = () => {
  ...
  const ourStoryItems = [
    {
      ...
      description: "CareerNest was founded in 2023 by a team of education technology enthusiasts who recognized a significant gap in how institutions maintained relationships with their alumni and professionals. Our founders envisioned a platform that would transform alumni and career engagement."
    },
    {
      icon: <Briefcase size={32} />,
      title: "Growth and Innovation",
      description: "What began as a simple alumni directory has evolved into a comprehensive platform with advanced networking capabilities, event management, job boards, and fundraising tools. Today, CareerNest serves hundreds of educational institutions and connects thousands of members worldwide."
    },
    {
      icon: <Users size={32} />,
  ...
  const teamMembers = [

    {
      ...
      description: "Ritik combines strong design sensibilities with technical expertise to create intuitive and engaging user experiences for our platform.",
      social: {
        linkedin: "#",
        github: "#",
        email: "ritik@careernest.com"
      }
    },
    {
      name: "Saksham Bindal",
      image: "https://api.dicebear.com/6.x/initials/svg?seed=KB&backgroundColor=fe6019",
      description: "With expertise in full-stack development and a passion for education technology, Saksham leads our development efforts and overall product vision.",
      social: {
        linkedin: "#",
        github: "#",
        email: "saksham@careernest.com"
      }
    },
    {
      name: "Saurabh",
      image: "https://api.dicebear.com/6.x/initials/svg?seed=LR&backgroundColor=fe6019",
  description: "Saurabh architects our robust backend systems and database infrastructure, ensuring CareerNest is secure, scalable, and reliable.",
      social: {
        linkedin: "#",
        github: "#",
        email: "saurabh@careernest.com"
      }
    }
  ];
  ...
  {/* The CareerNest Difference */}
      <AlumnLinkDifference />

      {/* Join Us CTA */}
      <CallToAction
        gradient={true}
        title="Join the CareerNest Community"
        description="Be part of a platform that's transforming how educational institutions, alumni, and professionals connect."
