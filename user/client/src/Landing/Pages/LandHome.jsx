...
const LandHome = () => {
  ...
  return (
    <AnimatePresence>
      <SEO 
        title="CareerNest - Leading Alumni & Career Platform | Connect, Engage, Grow"
        description="CareerNest is India's premier alumni and career networking platform. Transform your institution's alumni engagement and professional connections with our comprehensive tools and features."
        ...
        url="https://www.careernest.com"
        canonical="https://www.careernest.com"
      />
      <motion.div key="landhome-root"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
      ...
      >
        ...
        >
          ...
          {/* What Makes CareerNest the Obvious Choice section */}
          <ObviousChoice />
          ...
          {/* <FAQSection /> */}
            ...
            description="Join institutions across India who are building stronger alumni communities with CareerNest."
