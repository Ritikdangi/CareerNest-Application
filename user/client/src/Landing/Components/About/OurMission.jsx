        ...
        <div className="flex flex-col md:flex-row gap-12 items-center mb-20">
          ...
          >
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              Empower alumni communities to unlock lifelong value—professionally, personally, and collectively. CareerNest is built for meaningful connections, direct opportunities, and giving graduates and institutions the platform they need to thrive together.
            </p>
          </motion.div>
