        ...
        >
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-xl text-gray-600 leading-relaxed mb-8">
              CareerNest is the first social networking platform tailored specifically for alumni and professionals. 
              Forget generic social networks—this is your trusted space to reconnect, share knowledge, expand your career, and strengthen community ties.
            </p>
            ...
            {[
              {
                ...
                description: "Many alumni lose touch after graduation. CareerNest bridges that gap, letting you reconnect easily, anytime."
              },
              {
                title: "Career Growth", 
