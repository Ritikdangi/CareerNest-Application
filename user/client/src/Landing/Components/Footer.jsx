...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Linkedin size={20} />, href: 'https://linkedin.com/company/CareerNest', label: 'LinkedIn' },
    { icon: <Twitter size={20} />, href: 'https://twitter.com/careernest', label: 'Twitter' },
    { icon: <Instagram size={20} />, href: 'https://instagram.com/careernest', label: 'Instagram' },
    { icon: <Facebook size={20} />, href: 'https://facebook.com/careernest', label: 'Facebook' }
  ];
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-6 pb-8">
            ...
            >
              <h3 className="text-xl font-bold text-[#fe6019]">CareerNest</h3>
              <p className="text-xs text-gray-400 mt-1">Connecting Alumni & Careers</p>
            </motion.div>
            ...
            >
              ...
              <p className="mt-1">Building stronger alumni & career networks across India</p>
            </motion.div>
          </div>
        </motion.div>
      </div>
