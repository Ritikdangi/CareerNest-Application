...
const FAQSection = () => {
  ...
  const faqs = [
    {
      question: "How long does it take to set up CareerNest?",
    ...
    },
    {
      ...
      answer: "Yes! CareerNest supports imports from various formats including CSV, Excel, and direct API connections with major CRM and database systems."
    },
    {
    ...
    <section className="py-24 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 relative z-10">
        <SectionHeading
          ...
          badgeColor="yellow"
          title="Common questions about CareerNest"
