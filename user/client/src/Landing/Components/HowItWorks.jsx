    ...
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 relative z-10">
        <SectionHeading
          ...
          description="See how thousands of alumni are building meaningful connections, advancing careers, and giving back to their institutions through CareerNest's intelligent networking platform."
        />
        ...
        >
          ...
          >
            <h3 className="text-2xl font-bold text-gray-900 mb-4">
              ...
              Join leading institutions across India who trust CareerNest to power their alumni and career communities. 
