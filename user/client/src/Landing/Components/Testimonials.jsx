...
const Testimonials = () => {
  ...
  primary: "#fe6019", // CareerNest primary orange
  ...
  const testimonials = [
    {
  quote: "CareerNest helped us centralize our alumni network for the first time. Our graduates can now easily connect with each other and find mentorship opportunities.",
    ...
    {
  quote: "The platform made it simple to organize alumni events and track engagement. We've seen significant improvement in alumni participation since implementing CareerNest.",
    ...
    <section className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
        <SectionHeading
          ...
          description="See how educational institutions are building stronger alumni communities with CareerNest's comprehensive platform."
        />
