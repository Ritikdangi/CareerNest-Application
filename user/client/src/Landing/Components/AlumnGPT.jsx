...
const AlumnGPT = () => {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      text: "Hi! I'm CareerGPT, your AI assistant for CareerNest. I can help answer questions about our alumni and career platform, features, pricing, and how to get started. What would you like to know?",
      sender: 'bot',
      timestamp: new Date()
    }
  ]);
  ...
  // Knowledge base for CareerNest
  const knowledgeBase = {
    "features": "CareerNest offers comprehensive alumni and career networking features including: 1) Alumni Directory with advanced search and filtering, 2) Event Management and RSVP system, 3) Mentorship Matching between alumni and students, 4) Job Board with career opportunities, 5) Discussion Forums for community engagement, 6) News and Updates sharing, 7) Member Spotlights and success stories, 8) Private messaging and networking tools.",
    
  "pricing": "CareerNest offers flexible pricing plans: 1) Free Plan - Up to 100 members, basic features, 2) Professional Plan - $29/month for up to 500 members with advanced features, 3) Enterprise Plan - $99/month for unlimited members with premium features and dedicated support. All plans include mobile access and basic analytics.",
    
  "setup": "Getting started with CareerNest is easy: 1) Sign up for your free account, 2) Import your alumni database or add members manually, 3) Customize your platform with your institution's branding, 4) Set up user roles and permissions, 5) Launch and invite your community. Our team provides onboarding support and training.",
    
  "benefits": "CareerNest helps institutions and professionals: 1) Strengthen alumni and career engagement, 2) Increase donation and fundraising opportunities, 3) Provide career networking and mentorship programs, 4) Share institutional news and achievements, 5) Organize events effectively, 6) Track engagement analytics and insights, 7) Build a sustainable network for long-term growth.",
    
  "security": "CareerNest prioritizes data security with: 1) Enterprise-grade encryption for all data, 2) GDPR and FERPA compliance, 3) Secure cloud hosting with 99.9% uptime, 4) Regular security audits and updates, 5) User privacy controls and data management, 6) Secure payment processing, 7) Admin controls for user access and permissions.",
  ...
  const generateResponse = (message) => {
    ...
    if (lowerMessage.includes('hello') || lowerMessage.includes('hi') || lowerMessage.includes('hey')) {
      return "Hello! Welcome to CareerNest. I'm here to help you learn about our alumni and career platform. What specific information are you looking for today?";
    }
  ...
  return "You can start with our free trial! We offer a 14-day free trial with full access to all features. You can also schedule a personalized demo with our team to see how CareerNest can work for your institution. Would you like me to help you get started?";
    }
    
    // Default response
    return "I'd be happy to help you learn more about CareerNest! I can provide information about our features, pricing, setup process, benefits, security measures, and support options. You can also ask me about getting started with a demo or trial. What specific aspect of CareerNest interests you most?";
  };
          ...
          >
            ...
            <div className="bg-gradient-to-r from-[#fe6019] to-[#ff8a50] text-white p-4 flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-sm">CareerGPT</h3>
                ...
                <div className="p-4 border-t border-gray-200">
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      placeholder="Ask me about CareerNest..."
