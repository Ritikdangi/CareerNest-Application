    ...
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 relative z-10">
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          >
            <SectionHeading
              badge="Why choose CareerNest"
              badgeColor="purple"
              title="Purpose-built for alumni engagement"
              description="Unlike generic community platforms, CareerNest is designed specifically for educational institutions and their unique alumni engagement needs."
              centered={false}
            />
            ...
            >
              ...
              <div className="bg-white rounded-xl shadow-xl border border-gray-200 overflow-hidden">
                ...
                <motion.div 
                  ...
                  viewport={{ once: true }}
                >
                  <div className="font-bold">CareerNest Dashboard</div>
