    ...
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 relative z-10">
        <SectionHeading
          ...
          description="Stop juggling multiple tools. CareerNest provides all the features you need to build, engage and grow your alumni community in one powerful platform."
        />
