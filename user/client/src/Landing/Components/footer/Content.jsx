...
const Content = () => {
  ...
  const socialIcons = [
    { name: "LinkedIn", link: "https://www.linkedin.com/company/careernest/", icon: <Linkedin size={20} />, label: "LinkedIn" },
    { name: "Twitter", link: "https://twitter.com/careernest", icon: <Twitter size={20} />, label: "Twitter" },
    { name: "Instagram", link: "https://instagram.com/careernest", icon: <Instagram size={20} />, label: "Instagram" },
    { name: "Facebook", link: "https://facebook.com/careernest", icon: <Facebook size={20} />, label: "Facebook" }
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="mb-6">
              <img src="/careernest-logo.svg" alt="CareerNest" className="h-12 mb-4" style={{ maxHeight: 56 }} />
        ...
        <div className="border-t border-[#fe6019]/20 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <span className="font-medium text-[#fe6019]">CareerNest</span> - Transforming Alumni & Career Networks
            </div>
