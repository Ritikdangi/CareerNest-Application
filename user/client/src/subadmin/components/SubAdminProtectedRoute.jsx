...
const SubAdminProtectedRoute = ({ children, requiredPath }) => {
  ...
  // Use returned hierarchy or user document; default to 'alumni' (least privilege)
  const userHierarchy = hierarchyData?.adminHierarchy || authUser?.adminHierarchy || 'alumni';
