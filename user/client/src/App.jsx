...
function App() {
    ...
    const isAuthRoute = path === "/login" || path === "/signup" || path === "/forgot-password" || path.startsWith("/reset-password/");
    ...
    const { data: authUser, isLoading } = useQuery({
        ...
        enabled: !isAuthRoute, // Skip fetching auth on explicit auth pages
    });

    if (!isAuthRoute && isLoading) return null;
